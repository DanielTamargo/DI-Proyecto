...
class HavenFragment : Fragment() {
    ...
    companion object {
        ...
        fun newInstance(title: String, color: Int): HavenFragment {
            val fragment: HavenFragment = HavenFragment()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (arguments != null) {
            haven_titulo.text = arguments?.getString(ARG_TITLE) ?: "ERROR"
            //view.setBackgroundColor(arguments?.getInt(ARG_COLOR) ?: R.color.white)
        } else {
            haven_titulo.text = "ERROR"
            //view.setBackgroundColor(R.color.white)
        }

        //Subrayar título
        //Forma 1: Spannable, método correcto
        val titulo: TextView = view.findViewById(R.id.haven_titulo) ?: TextView(context)
        ...
        haven_checkBox_defensores.performClick()
        haven_checkBox_defensores.performClick()
        //haven_checkBox_defensores.isChecked = true
        //haven_checkBox_defensores.isChecked = false
